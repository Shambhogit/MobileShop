...
public class ListAdapter extends ArrayAdapter<DataModule> {

    Context context;
    ArrayList<DataModule> dataModules;
    public ListAdapter(Context context, ArrayList<DataModule> dataModules){
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(card == null){
            card = LayoutInflater.from(context).inflate(R.layout.list_card,parent,false);
        }
